...
expressApp.post('/api/stripe/2023-10-16/spaces/:spaceId/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
  ...
  const stripe = new Stripe(apiSecretKey, { apiVersion: '2024-04-10' });
