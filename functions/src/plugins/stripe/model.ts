...
export interface ProductContentData
  extends ContentData,
    Omit<
      Stripe.Product,
      'object' | 'created' | 'url' | 'metadata' | 'updated' | 'images' | 'tax_code' | 'default_price' | 'package_dimensions' | 'features'
    > {
...
export interface PriceContentData
  extends ContentData,
    Omit<
      Stripe.Price,
      'object' | 'created' | 'product' | 'metadata' | 'custom_unit_amount' | 'recurring' | 'tiers' | 'transform_quantity'
    > {
  schema: 'stripe-price';
