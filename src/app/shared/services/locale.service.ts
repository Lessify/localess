...
const SOURCE_SUPPORT_LOCALES = new Set([...GCP_BIDIRECTIONAL_LOCALES, ...GCP_SOURCE_ONLY_LOCALES]);
const TARGET_SUPPORT_LOCALES = new Set([...GCP_BIDIRECTIONAL_LOCALES, ...GCP_TARGET_ONLY_LOCALES]);
