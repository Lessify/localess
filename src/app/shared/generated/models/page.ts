...
export interface Page {
   ...
   */
  build_type?: null | 'legacy' | 'workflow';
   ...
   */
  pending_domain_unverified_at?: null | string;

  /**
   * The state if the domain is verified
   */
  protected_domain_state?: null | 'pending' | 'verified' | 'unverified';
   ...
   */
  status: null | 'built' | 'building' | 'errored';
