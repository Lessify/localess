...
export interface ActionsListWorkflowRuns$Params {
...
export function actionsListWorkflowRuns(http: HttpClient, rootUrl: string, params: ActionsListWorkflowRuns$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'total_count': number;
'workflow_runs': Array<WorkflowRun>;
}>> {
  const rb = new RequestBuilder(rootUrl, actionsListWorkflowRuns.PATH, 'get');
  if (params) {
...
actionsListWorkflowRuns.PATH = '/repos/{owner}/{repo}/actions/workflows/{workflow_id}/runs';
