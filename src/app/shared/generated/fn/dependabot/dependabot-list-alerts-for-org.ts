...
export interface DependabotListAlertsForOrg$Params {
...
export function dependabotListAlertsForOrg(http: HttpClient, rootUrl: string, params: DependabotListAlertsForOrg$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<DependabotAlertWithRepository>>> {
  const rb = new RequestBuilder(rootUrl, dependabotListAlertsForOrg.PATH, 'get');
  if (params) {
...
dependabotListAlertsForOrg.PATH = '/orgs/{org}/dependabot/alerts';
