...
export interface DependabotCreateOrUpdateOrgSecret$Params {
...
export function dependabotCreateOrUpdateOrgSecret(http: HttpClient, rootUrl: string, params: DependabotCreateOrUpdateOrgSecret$Params, context?: HttpContext): Observable<StrictHttpResponse<EmptyObject>> {
  const rb = new RequestBuilder(rootUrl, dependabotCreateOrUpdateOrgSecret.PATH, 'put');
  if (params) {
...
dependabotCreateOrUpdateOrgSecret.PATH = '/orgs/{org}/dependabot/secrets/{secret_name}';
