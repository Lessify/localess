...
import { MARKETING_TEMPLATE } from './marketing.template';
...
export const SPACE_TEMPLATES: SpaceTemplate[] = [EMPTY_TEMPLATE, BLOG_TEMPLATE, ECOMMERCE_TEMPLATE, MARKETING_TEMPLATE];

export { BLOG_TEMPLATE, ECOMMERCE_TEMPLATE, EMPTY_TEMPLATE, MARKETING_TEMPLATE };
